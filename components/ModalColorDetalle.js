...
import {
  ...
  const ModalColorDetalle = ({ colorSeleccionada, setColorSeleccionada }) => {
    ...
    return (
      <>
        <View style={{...styles.contenido, backgroundColor: colorSeleccionada.color}}>
          <TouchableOpacity
          ...
          >
            <AntDesign name="closecircle" size={32} color= {colorSeleccionada.color === "red" ? "white" : "red"} />
          </TouchableOpacity>
          ...
          <View style={styles.detalles}>
            ...
            <TouchableOpacity
                    ...
                    onPress={() =>
                      Speech.speak(`${colorSeleccionada.nombre}`)
                    }
                  >
              <Text style={styles.txtHeader}>
                {colorSeleccionada.nombre}
              </Text>
              </TouchableOpacity>
