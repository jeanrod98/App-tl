...
import musica_fondo_2 from "../assets/musica_fondo_2.jpg";
...
const EscogerInstrumento = ({ setEscogerObjetos }) => {
        ...
        <View style={{ ...styles.contenido }}>
          <View style={styles.header}>
            <Text style={styles.txtHeader}>
              Escoge el instrumento que sale en la figura
            </Text>
          ...
          >
            {mostrarGame ? (
              <InstrumentosOneGame
                ...
                errores={errores}
                tiempo={tiempo}
                dinamica={"Escoge el instrumento que sale en la figura"}
              />
            ) : (
              <>
                <TouchableOpacity
...
export default EscogerInstrumento;
