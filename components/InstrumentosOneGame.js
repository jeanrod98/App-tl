  ...
  const InstrumentosOneGame = ({ dinamica }) => {
    ...
    const generarColorAleatorio = async () => {
      ...
      let arregloNumeros = [
        ...
        { nombre: "BATERÍA", source_1: img_bateria, source_2: instrumento_bateria },
        ...
        { nombre: "TROMPETA", source_1: img_trompeta, source_2: instrumento_trompeta },
        { nombre: "ACORDEÓN", source_1: img_acordeon, source_2: instrumento_acordeon },
    ...
    return (
      <>
        ...
        <Text
          ...
          <View style={{...styles.contenidoCard, flexDirection: "column", gap: 10}}>
            ...
            >
                <Image style={{...styles.imgCard, width: 150, height: 150}} source={colorCard?.source_2}/>
          ...
          <View style={styles.contenidoCard}>
            <Text style={{ position: "absolute", top: 70, right: 100, zIndex: 1}}>O</Text>
